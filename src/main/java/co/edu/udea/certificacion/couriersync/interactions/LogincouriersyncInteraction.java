...
public class LogincouriersyncInteraction implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(Enter.theValue("123").into(PASSWORD_TEXT_BOX));
        WaitTime.putWaitTimeOf(800);
    ...
    public static LogincouriersyncInteraction userAndPassword() {
        return Tasks.instrumented(LogincouriersyncInteraction.class);
    }
}
